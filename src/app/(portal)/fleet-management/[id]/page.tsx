...
const vehicles = [
  {
    ...
    fuel: "78%",
    mileage: "182,430 km",
    vin: "1XKAD49X5SJ123456",
    color: "Blanco",
    lastService: "15 agosto 2026",
    nextService: "15 noviembre 2026",
    insurance: "Vigente",
    registration: "Vigente",
  },
  {
    id: "JT-002",
    model: "Kenworth T680",
    ...
    fuel: "94%",
    mileage: "154,820 km",
    vin: "1XKAD49X5SJ234567",
    color: "Blanco",
    lastService: "2 septiembre 2026",
    nextService: "2 diciembre 2026",
    insurance: "Vigente",
    registration: "Vigente",
  },
  {
    ...
    fuel: "42%",
    mileage: "221,640 km",
    vin: "1XKAD49X5SJ345678",
    color: "Rojo",
    lastService: "4 septiembre 2026",
    nextService: "Pendiente",
    insurance: "Vigente",
    registration: "Vigente",
  },
  {
    ...
    fuel: "61%",
    mileage: "198,210 km",
    vin: "1XKAD49X5SJ456789",
    color: "Blanco",
    lastService: "20 julio 2026",
    nextService: "20 octubre 2026",
    insurance: "Vigente",
    registration: "Vigente",
  },
  {
    ...
    fuel: "87%",
    mileage: "246,580 km",
    vin: "1XKAD49X5SJ567890",
    color: "Blanco",
    lastService: "28 agosto 2026",
    nextService: "28 noviembre 2026",
    insurance: "Vigente",
    registration: "Vigente",
  },
];
        ...
        <header className="mb-8">
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                type="button"
                className="inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-company px-4 text-sm font-bold text-white shadow-sm transition hover:bg-company-600"
              >
                Editar unidad
              </button>
            </div>
          ...
          <aside className="space-y-6">
            ...
            <section className="rounded-2xl bg-zinc-900 p-5 text-white shadow-sm">
              ...
              <div className="mt-6">
                ...
                <p className="mt-1 text-2xl font-bold">{vehicle.status}</p>
