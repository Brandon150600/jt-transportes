...
export async function createVehicle(
    ...
    redirect(`/fleet-management/${vehicle.id}`);
}
...
export async function updateVehicle(
    ...
    if (existingVehicle) {
        return {
            error: "Ya existe otra unidad con ese número económico.",
        };
    }
    ...
    try {
        ...
        return {
            error: "No fue posible actualizar la unidad.",
        };
    }

    redirect(`/fleet-management/${data.id}`);
}